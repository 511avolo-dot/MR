...
| F1 · baseline determinism (drift guard) | `node scripts/deploy/build-baseline.mjs --check` | **LOCAL PASS (2026-08-09; exact branch content, CI pending)** — sha256 `ffb7c23da96571187f253e659ab95c3b207cb87af7091232d0f70829be0046ea` reproducible from `portal-standalone.sql` |
