...
const ERR_AR = {
  ...
  // عُدِّل محتوى الطلب بعد إرسال هذا البريد، فالرمز يخصّ نسخةً لم تعد قائمة.
  stale_revision: 'عُدِّل الطلب بعد إرسال هذا البريد — افتح الطلب في النظام لمراجعة النسخة الجديدة قبل قرارك.',
