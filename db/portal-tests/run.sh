...
run_sql "p0_2g: مورد الفاتورة ومبلغها من التعميد المعتمد" "$HERE/60_invoice_award_authority.sql"

echo ""
echo "✅ كل اختبارات البوابة نجحت (393 تأكيد SQL) + 18 حارس ملفات + 7 نقطة رفع الوثائق + 26 نقطة تجديد المستندات."
