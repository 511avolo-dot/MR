...
#  P0-1b…P0-1h تُطبّق قبل اختبارات أقلّ الامتياز والصلاحيات الحرجة
#  وسياسات سير العمل وعقد تجربة الطالب الآمن.
# ════════════════════════════════════════════════════════════════════════════
set -euo pipefail
...
echo ""
echo "✅ كل اختبارات البوابة نجحت (230 تأكيد SQL) + 18 تأكيد حارس ملفات + 7 تأكيدات نقطة رفع وثائق التسجيل."
