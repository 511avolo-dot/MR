-- ═══════════════════════════════════════════════════════════════════════════
--  الهجرة 024 — أساس الترسية المجزّأة (المرحلة ب، الأساس الخلفي فقط — إضافة بحتة)
--  المشروع: mwbjoysuybgbrvfrprex (البوابة، نظام 3)
--  الغرض: تخزين ترسية بند→مورد (توريد بنود مختلفة لموردين مختلفين) في جدول مستقل
--         `portal_award_lines`، ودالة `portal_award_split` تُنشئ الترسية المجزّأة
--         وتبني سلسلة اعتماد التعميد على القيمة الإجمالية (التعميد = مدير المشتريات
--         حسب مصفوفة المالك). **إضافة بحتة: لا تمسّ portal_award/portal_payment القائمة،
--         والترسية المفردة تبقى كما هي.** التنفيذ الكامل لكل مورد (صرف/استلام بآيبان كل
--         مورد — النموذج «أ») يُبنى في هجرة لاحقة بعد إقرار المالك. idempotent. شغّلها بعد 023.
-- ═══════════════════════════════════════════════════════════════════════════
