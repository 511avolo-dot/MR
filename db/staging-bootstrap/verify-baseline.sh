...
#  P0-1b/P0-1c/P0-1d/P0-1e تُطبّق قبل اختبارات أقلّ الامتياز/سرية العروض
#  لإثبات إغلاق blockers بدون كسر بقية الحزمة.
# ════════════════════════════════════════════════════════════════════════════
set -euo pipefail
...
a_pass=0; a_skip=0; a_p0b=0; a_p0d=0; a_p0e=0
...
echo "   ✓ المرحلة أ: $a_pass نجح · $a_skip مؤجَّل لِما-بعد-062 · P0-1b/P0-1d/P0-1e طبّقت"
...
b_pass=0; b_p0b=0; b_p0d=0; b_p0e=0
for f in $(ls "$ROOT"/db/portal-tests/[0-9]*.sql | sort); do
  b=$(basename "$f")
...
echo "   ✓ المرحلة ب: $b_pass ملفّ نجح على (أساس+062+P0-1b/P0-1d/P0-1e)"

echo "▶ [7] ✅ F1 proof PASS — Phase A(061)=$a_pass نجح/$a_skip مؤجَّل · 062 ✓ · P0-1b/P0-1d/P0-1e ✓ · Phase B=$b_pass نجح — خروج 0"
