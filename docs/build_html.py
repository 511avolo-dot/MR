...
AXES = [
    ...
    ("ثالثاً: تسعير المناقصات وسجل الأسعار", [
        ...
        ("لا تاريخ لأسعار المواد", "تغذّيه المشتريات يدوياً حالياً، ويُؤتمَت من النظام المالي بعد تشغيل نظام المشتريات"),
    ...
    ("رابعاً: الموردون والعلاقات", [
        ...
        ("الطلبات المستديمة تُسعّر يدوياً", "تخضع لثلاثة عروض كاملة كغيرها دون استثناء"),
    ...
    ("سابعاً: التكامل مع الإدارة المالية", [
        ("بطء التحويل للموردين وتعليق المعاملات", "مدة ملزمة (٣–٥ أيام)، ودفعات أسبوعية، وتصعيد للإدارة العليا عند التجاوز"),
        ("لا تغذية آلية لسجل المناقصات", "ربطه بفواتير النظام المالي بعد تشغيل نظام المشتريات"),
...
POLICIES = [
    ...
    ("الاستثناءات الموثّقة", "النثريات والطوارئ ضمن سقف"),
...
PROC = [
    ...
    ("٩) الإشعار والتعاقد", "إشعار المورد بالشروط", "المشتريات"),
    ("١٠) الصرف/التحويل", "تحويل المستحق (غالباً قبل التوريد)", "المالية"),
    ("١١) التوريد", "متابعة التسليم", "المشتريات"),
    ("١٢) الاستلام والفحص", "فحص المطابقة للمواصفات", "المستودعات"),
    ("١٣) المطابقة", "مطابقة المستندات", "المشتريات"),
    ("١٤) الإغلاق", "إقفال وأرشفة", "المشتريات"),
]

FLOW = ["نشوء الاحتياج", "طلب رسمي بالمواصفات", "فحص المستودع", "طلب ثلاثة عروض",
        "المقارنة", "الاعتماد حسب الصلاحية", "أمر الشراء", "الصرف/التحويل",
        "الاستلام والفحص", "الإغلاق"]
...
PR_TILES = [
    ("—", "بند مسجّل", "في سجل الأسعار", "i"),
    ("—", "سعر مرجعي", "للرجوع إليها في المناقصات", "gold"),
    ("26", "فئة", "تغطّي مواد المشاريع", "g"),
    ("42", "مورد مسجّل", "بسجلّات وبيانات تواصل", "i"),
]
...
<b style="color:var(--gold)">من الصفر إلى منظومة:</b> عند استلام الإدارة لم يكن هناك سجل أسعار، وكان عدد الموردين المستلَمين ٤ فقط؛ واليوم أصبح لدينا ٤٢ مورداً في ٢٦ فئة وسجل أسعار مرجعي يُبنى ويُحدَّث باستمرار.</div>
