...
TILES = [
    ("53", "أمر شراء", "سجل الأوامر المُحلَّل", "i"),
    ("68٪", "طلبات متأخرة", "٣٦ من ٥٣", "r"),
    ("19", "يوم متوسط التأخير", "أقصى تأخير ٥٢ يوماً", "r"),
    ("23٪", "لم تكتمل", "١٢ طلباً ملغى/قيد المراجعة", "a"),
    ("39٪", "تأخيرها بسبب المالية", "١٤ من ٣٦ متأخراً", "r"),
...
BIG3 = [("39٪", "من الطلبات المتأخرة", "سببها التحويل المالي (١٤ من ٣٦)", "r"),
