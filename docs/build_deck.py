...
tiles = [
    ('53', 'أمر شراء', INK, 'سجل الأوامر المُحلَّل'),
    ('68٪', 'طلبات متأخرة', RED, '36 من 53'),
    ('19', 'يوم متوسط التأخير', RED, 'أقصى تأخير 52 يوماً'),
    ('23٪', 'لم تكتمل', AMBER, '12 طلباً ملغى/قيد المراجعة'),
    ('39٪', 'تأخيرها بسبب المالية', RED, '14 من 36 متأخراً'),
...
big = [
    ('39٪', 'من الطلبات المتأخرة', 'سببها التحويل المالي (14 من 36)', RED),
