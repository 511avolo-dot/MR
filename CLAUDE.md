...
`005` → `006` → `007` → `008` → `009` → `010` → `011` → `012` → `013-committee-mgmt` → `014-sla-role-holders` → `015-pending-approver-visibility`
**(من شغّل حتى 012: يكفيه `013+014+015`. ملف مجمّع: `RUN-ALL-005-to-015.sql`.)**
