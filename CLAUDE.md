...
`005` → `006` → `007` → `008` → `009` → `010` → `011` → `012` → `013-committee-mgmt` → `014-sla-role-holders` → `015-pending-approver-visibility` → `016-payment-sod-3way` → `017-revoke-run-sla` → `018-save-job-committee-key`
**(من شغّل حتى 017: يكفيه `018`. ملف مجمّع: `RUN-ALL-005-to-018.sql`.)**
